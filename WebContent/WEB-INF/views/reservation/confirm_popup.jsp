...
<div id="container" align="center"> 
	<div style="border: 1px solid #333; width:400px ; height: 450px;">
	<br/><br/>
	<% ReservationTotalVO rsVO = (ReservationTotalVO)request.getAttribute("rInfo"); %>
		<table>
			...
			<%
		if(rsVO.getPay_method().equals("B")){
		...
		<%-- 	<tr class="trTable">
			...
			<tr class="trTable">
				<td class="tdTable"><strong>결제요금</strong></td><td class="tdTable"><strong><c:out value="${rInfo.charge }"></c:out></strong></td>			
					...
					<%
		if(rsVO.getPay_status().equals("D") && rsVO.getPay_method().equals("B")){
			BankInfoDomain bid = (BankInfoDomain)request.getAttribute("bInfo");
		...
		%>
		<input type="button" value="결제" class="btn btn-secondary alert-secondary" id="paymentBtn">
