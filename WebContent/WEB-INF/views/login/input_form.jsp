...
<form class="card" id="cardInfoFrm" action="finish_signUp.do" method="post" style="width: 580px; height: 560px; padding-top: 20px ; margin-left: auto; margin-right: auto;">
	<div class="card-body" align="center" >
		<div><img src="http://localhost:8080/3rd_prj/common/images/credit-card3.png">&nbsp;&nbsp;&nbsp;&nbsp;<strong>결제정보 입력</strong></div><br/>
			...
			<table>
				<tr>
					<td style="width: 100px; padding-top: 0px" >카드번호</td>
					<td>
						  <div class="form-row">
			...
			<option value="${ cardTypeList.cardTypeCode }"><c:out value="${ cardTypeList.cardType }"/></option>
				...
				<tr>
					<td style="padding-top: 0px">만료일</td>
					<td style="padding-top: 20px">
					
					 <!-- maxlength의 값을 5로지정하여 다섯자리 이상의 값이 등록되는것을 막는다. onKeyup="inputValidThru(this)"--> 
						<input type="text" class="form-control" style="width: 100px" id="expireDate" name="exDate"  placeholder="MM/YY"  maxlength="5">
				...
				<br/><br/>
				<div>
				<button type="button" class="btn btn-secondary alert-danger btn" id="goBtn">가입하기</button>
