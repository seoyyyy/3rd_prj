...
public class CardListDomain {
	private String card_type, ex_date, card_info_code, card_num4;
	...
	public String toString() {
		return "CardListDomain [card_type=" + card_type + ", ex_date=" + ex_date + ", card_info_code=" + card_info_code
				+ ", card_num4=" + card_num4 + "]";
	}
