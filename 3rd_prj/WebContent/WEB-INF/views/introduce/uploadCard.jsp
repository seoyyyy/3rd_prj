...
<style type="text/css">
	...
	/* 컨테이너 시작 */
	#container{ width: 900px; height: 700px; margin-top:70px;}
...
<form>
  <div class="form-group row">
    <label for="inputEmail3" class="col-sm-2 col-form-label">카드번호</label>
    <div class="col-sm-4">
      <input type="email" class="form-control" id="inputEmail3" placeholder="카드번호">
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword3" class="col-sm-2 col-form-label">카드유형</label>
    <div class="col-sm-4">
    <select class="custom-select mr-sm-2" id="inlineFormCustomSelect">
        <option selected>카드목록</option>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="password" class="form-control" id="AddrIp" placeholder="주소"><br/>
      <input type="password" class="form-control" id="Addr" placeholder="주소"><br/>
      <input type="password" class="form-control" id="AddrDetail" placeholder="상세주소">
    </div>
  </div>
  <div class="form-group row">
